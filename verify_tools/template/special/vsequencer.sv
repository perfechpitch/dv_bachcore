// ============================================================================
// Filename             : $(CLASSNAME)_vsequencer.sv
// Author               : $(USER)
// Created On           : $(Date)
// Last Modified        :
// Update Count         :
...
`ifndef $(FILENAME)_VSEQUENCER_SV
`define $(FILENAME)_VSEQUENCER_SV

class $(CLASSNAME)_vsequencer extends uvm_sequencer;
    ...
    `uvm_component_utils_begin($(CLASSNAME)_vsequencer)
...
endclass : $(CLASSNAME)_vsequencer
