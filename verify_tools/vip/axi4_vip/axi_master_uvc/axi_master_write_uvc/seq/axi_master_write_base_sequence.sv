// ============================================================================
// Filename             : axi_master_write_base_sequence.sv
// Author               : kippy xyz
...
// Description          :
// ============================================================================
`ifndef AXI_MASTER_WRITE_BASE_SEQUENCE_SV
`define AXI_MASTER_WRITE_BASE_SEQUENCE_SV
class axi_master_write_base_sequence #(
    ...
    typedef axi_master_write_base_sequence #(
    ...
    function new(string name = "axi_master_write_base_sequence");
        super.new(name);
    endfunction
endclass : axi_master_write_base_sequence
`endif
