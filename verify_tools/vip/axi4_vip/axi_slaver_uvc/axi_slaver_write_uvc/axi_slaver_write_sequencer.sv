// ============================================================================
// Filename             : axi_slaver_write_sequencer.sv
// Author               : kippy xyz
// Created On           : 2026-6-30
// Last Modified        :
// Update Count         :
// Description          : Reserved AXI write slaver sequencer extension shell.
// ============================================================================
`ifndef AXI_SLAVER_WRITE_SEQUENCER_SV
`define AXI_SLAVER_WRITE_SEQUENCER_SV

class axi_slaver_write_sequencer #(
...
) extends uvm_sequencer #(axi_slaver_write_seq_item #(
    ...
    virtual task wait_for_grant(
        ...
        `uvm_fatal("AXI_SLAVER_SEQUENCE_DISABLED", axi_diag::format(
            "SLAVE_WRITE_SEQUENCE_ITEM_UNSUPPORTED", "SLAVE", "B",
            "sequence_submission",
            ...
            "configure axi_slaver_write_cfg and let the reactive Driver respond after accepted AW plus complete W",
            "reject_sequence_item_without_waiting", get_full_name()))
    endtask : wait_for_grant
endclass : axi_slaver_write_sequencer
`endif
