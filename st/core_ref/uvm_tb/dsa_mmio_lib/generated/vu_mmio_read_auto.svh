...
if(!mmio_hit && (addr == INF_REPLACE_VALUE_BASE_ADDR)) begin
    data = inf_replace_value_val;
    mmio_hit = 1'b1;
end
if(!mmio_hit && (addr == NAN_REPLACE_VALUE_BASE_ADDR)) begin
    data = nan_replace_value_val;
    mmio_hit = 1'b1;
end
