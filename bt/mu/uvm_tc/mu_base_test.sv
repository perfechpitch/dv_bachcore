...
// Description          :
// ============================================================================
`ifndef MU_BASE_TEST_SV
`define MU_BASE_TEST_SV
class mu_base_test extends uvm_test;
    `uvm_component_utils(mu_base_test)

    mu_environment      mu_env;
    ...
    function void build_phase(uvm_phase phase);
        ...
        // Create the tb
        mu_env = mu_environment::type_id::create("mu_env", this);
    ...
    function set_config_params();
        if(mu_case_cfg==null)begin
            mu_case_cfg = mu_case_config::type_id::create("mu_case_cfg",this);
            uvm_config_db#(mu_case_config)::set(this,"mu_env*","mu_case_cfg",this.mu_case_cfg);
        end
    endfunction

    virtual function set_config_random();
        assert(mu_case_cfg.randomize());
    endfunction

    virtual function void set_config_special_random();
        mu_case_cfg.random_case();
    endfunction
