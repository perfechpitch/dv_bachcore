...
// Description          :
// ============================================================================
`ifndef MU_CASE_CONFIG_SV
`define MU_CASE_CONFIG_SV
class mu_case_config extends uvm_object;
    ...
    `uvm_object_utils_begin(mu_case_config)
    ...
    function new (string name = "mu_case_config");
        super.new(name);
