...
// Description          :
// ============================================================================
`ifndef MU_BASE_VSEQUENCE_SV
`define MU_BASE_VSEQUENCE_SV
class mu_base_vsequence extends uvm_sequence;
    //
    ...
    `uvm_object_utils(mu_base_vsequence)
    `uvm_declare_p_sequencer(mu_vsequencer)


    function new(string name = "mu_base_vsequence");
        super.new(name);
